...
@click.option('--duration', default='long', help="It could be short or long")
@click.option('--published', default='20-01-01T00:00:00Z', help="It should be a date YYYY-MM-DD")
